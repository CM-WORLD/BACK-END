...
class CmsWorldApplicationTests {
    ...
    void cmsInsert () {
        CmsApplyDto input = CmsApplyDto.builder().content("메이플 2명 배경 신청합니다.")
                .cms_tp(GlobalCode.TYPE_COUP_BG.getCode())
                .user_name("류시아")
                .bank_owner("유시아")
                .build();
        ...
        CmsApplyImgDto inputImgs = CmsApplyImgDto.builder()
                .img_url("https://jvk-world.s3.ap-northeast-2.amazonaws.com/test_01.jpg")
                .applyDto(dto)
                .build();
...
//    @Transactional
    ...
    public void updateStatus () {
        ...
        dto2.setCms_tp(GlobalCode.TYPE_SINGLE.getCode());
        dto2.setContent("벽한 요청 드립니다.");
